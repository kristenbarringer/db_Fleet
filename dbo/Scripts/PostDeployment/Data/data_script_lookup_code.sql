...
,('language_assets','CZECH','czech','LNG_CZECH','Czech','Czech','','lang_id','CS','country_id','CZ','14','1')
,('language_assets','DUTCH','dutch','LNG_DUTCH','Dutch','Dutch','','lang_id','NL','country_id','NL','1','1')
,('language_assets','ENGLISH','english','LNG_ENGLISH','English','English','','lang_id','EN','country_id','IE','2','1')
,('language_assets','ENGLISH_US','englishUs','LNG_ENGLISH_US','English (US)','English (US)','','lang_id','EN','country_id','US','4','1')
,('language_assets','ESTONIAN','estonian','LNG_ESTONIAN','Estonian','Estonian','','lang_id','ET','country_id','ET','17','1')
,('language_assets','FINNISH','finnish','LNG_FINNISH','Finnish','Finnish','','lang_id','FI','country_id','FI','10','1')
,('language_assets','FRENCH','french','LNG_FRENCH','French','French','','lang_id','FR','country_id','FR','5','1')
,('language_assets','GERMAN','german','LNG_GERMAN','German','German','','lang_id','DE','country_id','DE','6','1')
,('language_assets','GREEK','greek','LNG_GREEK','Greek','Greek','','lang_id','EL','country_id','GR','12','1')
,('language_assets','HEBREW','hebrew','LNG_HEBREW','Hebrew','Hebrew','','lang_id','IW','country_id','IW','9','1')
,('language_assets','ITALIAN','italian','LNG_ITALIAN','Italian','Italian','','lang_id','IT','country_id','IT','7','1')
,('language_assets','POLISH','polish','LNG_POLISH','Polish','Polish','','lang_id','PL','country_id','PL','13','1')
,('language_assets','PORTUGUESE','portuguese','LNG_PORTUGUESE','Portuguese','Portuguese','','lang_id','PT','country_id','PG','16','1')
,('language_assets','RUSSIAN','russian','LNG_RUSSIAN','Russian','Russian','','lang_id','RU','country_id','RU','11','1')
,('language_assets','SPANISH','spanish','LNG_SPANISH','Spanish','Spanish','','lang_id','ES','country_id','ES','8','1')
,('language_assets','SWEDISH','swedish','LNG_SWEDISH','Swedish','Swedish','','lang_id','SV','country_id','SW','15','1')


,('language_accounts','CZECH','czech','LNGAC_CZECH','Czech','Czech','','lang_id','CS','country_id','CZ','13','1')
,('language_accounts','DUTCH','dutch','LNGAC_DUTCH','Dutch','Dutch','','lang_id','NL','country_id','NL','1','1')
,('language_accounts','ENGLISH','english','LNGAC_ENGLISH','English','English','','lang_id','EN','country_id','IE','2','1')
,('language_accounts','ENGLISH_US','englishUs','LNGAC_ENGLISH_US','English (US)','English (US)','','lang_id','EN','country_id','US','3','1')
,('language_accounts','ESTONIAN','estonian','LNGAC_ESTONIAN','Estonian','Estonian','','lang_id','ET','country_id','ET','16','1')
,('language_accounts','FINNISH','finnish','LNGAC_FINNISH','Finnish','Finnish','','lang_id','FI','country_id','FI','9','1')
,('language_accounts','FRENCH','french','LNGAC_FRENCH','French','French','','lang_id','FR','country_id','FR','4','1')
,('language_accounts','GERMAN','german','LNGAC_GERMAN','German','German','','lang_id','DE','country_id','DE','5','1')
,('language_accounts','GREEK','greek','LNGAC_GREEK','Greek','Greek','','lang_id','EL','country_id','GR','11','1')
,('language_accounts','HEBREW','hebrew','LNGAC_HEBREW','Hebrew','Hebrew','','lang_id','IW','country_id','IW','8','1')
,('language_accounts','ITALIAN','italian','LNGAC_ITALIAN','Italian','Italian','','lang_id','IT','country_id','IT','6','1')
,('language_accounts','POLISH','polish','LNGAC_POLISH','Polish','Polish','','lang_id','PL','country_id','PL','12','1')
,('language_accounts','PORTUGUESE','portuguese','LNGAC_PORTUGUESE','Portuguese','Portuguese','','lang_id','PT','country_id','PG','15','1')
,('language_accounts','RUSSIAN','russian','LNGAC_RUSSIAN','Russian','Russian','','lang_id','RU','country_id','RU','10','1')
,('language_accounts','SPANISH','spanish','LNGAC_SPANISH','Spanish','Spanish','','lang_id','ES','country_id','ES','7','1')
,('language_accounts','SWEDISH','swedish','LNGAC_SWEDISH','Swedish','Swedish','','lang_id','SV','country_id','SW','14','1')
