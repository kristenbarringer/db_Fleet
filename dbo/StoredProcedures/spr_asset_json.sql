...
from asset a LEFT OUTER JOIN asset_type b on a.asset_type_rid = b.asset_type_rid 
LEFT OUTER JOIN asset_group_mapping c on a.asset_rid=c.asset_rid and a.active = 1
LEFT OUTER JOIN equipment d on a.asset_rid = d.asset_rid 
LEFT OUTER join equipment_device_mapping e on d.equipment_rid = e.equipment_rid 
LEFT OUTER join device f on f.device_rid=e.device_rid
