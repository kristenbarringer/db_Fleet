...
--alter table asset_group add v1_vehicle_group_rid int
CREATE    procedure [dbo].[asset_group_user_update_custom]
...
insert into asset_group(asset_group_name,tenant_id,v1_vehicle_group_rid) select vehicle_group,customer_rid,v1_vehicle_group_rid from v1_asset_group
...
select b.asset_rid,v1_vehicle_group_rid from v1_asset_group_mapping a, asset_info b where a.v1_vehicle_rid = b.v1_vehicle_rid -- where asset_rid>
AND a.pipeline_id = @pipeline_run_id;
...
select v1_user_rid,v1_vehicle_group_rid,getdate() from v1_user_asset_group_mapping
WHERE pipeline_id = @pipeline_run_id;
